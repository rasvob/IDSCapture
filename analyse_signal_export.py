...
if DEBUG:
    df_avg = pd.read_csv('D:\Hella\Hrabova_test_long_spatne_svetlo_128\Hrabova_test_long_spatne_svetlo_128_30_raw.csv', sep=';').iloc[:, 1:]
    df_avg.columns = ['Edge_Avg', 'FrameTimestamp_us']
else:
